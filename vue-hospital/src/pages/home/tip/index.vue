<template>
    <div class="tip">
        ...
        <div class="department">
            <div class="header">
                <div class="left">
                    <svg t="1743149440702" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="2683" width="16" height="16">
                        <path
                        ...
                        <path
                            ...
                            fill="#d81e06" p-id="2689"></path>
                    </svg>
                    <span>常见科室</span>
                </div>
                <div class="right">
                    <span>全部</span>
                    <svg t="1743149585043" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="3738" width="16" height="16">
                        <path
                            d="M283.648 174.081l57.225-59.008 399.479 396.929-399.476 396.924-57.228-59.004 335.872-337.92z"
                            fill="#272636" p-id="3739"></path>
                    </svg>
                </div>
            </div>
            <div class="content">
        ...
        <div class="notice">
            <div class="header">
                <div class="left">
                    <svg t="1743153405208" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5846" width="16" height="16"><path d="M736 768h-448a32 32 0 0 1 0-64h448a32 32 0 0 1 0 64z m-44.8-415.552l-147.669333-147.669333a61.994667 61.994667 0 0 1-62.848 0l-147.669334 147.669333a32.554667 32.554667 0 0 1-46.037333-46.037333l161.578667-161.578667a63.68 63.68 0 0 1 127.104 0l161.578666 161.578667a32.554667 32.554667 0 0 1-46.037333 46.037333zM565.333333 512a32 32 0 0 1 0 64h-277.333333a32 32 0 0 1 0-64h277.333333z" fill="#2c2c2c" p-id="5847"></path><path d="M853.333333 981.333333H170.666667a85.333333 85.333333 0 0 1-85.333334-85.333333V384a85.333333 85.333333 0 0 1 85.333334-85.333333h682.666666a85.333333 85.333333 0 0 1 85.333334 85.333333v512a85.333333 85.333333 0 0 1-85.333334 85.333333z m21.333334-576a42.666667 42.666667 0 0 0-42.666667-42.666666H192a42.666667 42.666667 0 0 0-42.666667 42.666666v469.333334a42.666667 42.666667 0 0 0 42.666667 42.666666h640a42.666667 42.666667 0 0 0 42.666667-42.666666V405.333333z" fill="#2c2c2c" p-id="5848"></path></svg>
                    <span>停诊公告</span>
                </div>
                <div class="right">
                    <span>全部</span>
            ...
            <div class="content">
                <ul>
                    <li>eius. Ipsa similique dolorum voluptas! Aliquam eos sed ab blanditiis iste. Repellat magni, nostrum recusandae ipsa voluptatem hic tenetur quaerat maiores.</li>
                    <li>distinctio quia inventore sequi obcaecati debitis recusandae impedit expedita porro eligendi, itaque voluptatibus ab amet quas. Illum corporis animi a dolor?</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate sunt ex, consectetur voluptas placeat sequi in assumenda adipisci doloribus excepturi corrupti recusandae explicabo voluptate dicta, esse dolores repellat quisquam tempore.</li>
                </ul>
            </div>
